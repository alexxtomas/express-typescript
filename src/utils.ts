...
const isVisiblity = (visibility: any): boolean => {
...
const parseVisibility = (visibilityFromRequest: any): Visibility => {
  if (!isString(visibilityFromRequest) || !isVisiblity(visibilityFromRequest)) throw new Error('Incorrect or missing visibility')
